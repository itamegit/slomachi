...
GNAVI_AUTO;
	 ...
	 *---------------------------------------------------------------------------*/
	/* Body */
	if( isset( $luxe['body_color'] ) || isset( $luxe['body_bg_color'] ) || isset( $luxe['body_bg_img'] ) || ( isset( $luxe['body_transparent'] ) && $luxe['body_transparent'] !== 100 ) ) {
		$style['all'] .= 'body{';
		...
		if( isset( $luxe['body_bg_color'] ) || isset( $luxe['body_bg_img'] ) || ( isset( $luxe['body_transparent'] ) && $luxe['body_transparent'] !== 0 ) ) {
			$style['all'] .= 'background:';
			/* 背景色 */
			if( isset( $luxe['body_bg_color'] ) ) {
				$style['all'] .= $luxe['body_bg_color'] . ';';
			}
			/* 背景画像 */
			if( isset( $luxe['body_bg_img'] ) ) {
				...
				$style['all'] .= 'url("' . $luxe['body_bg_img'] . '");';
			}
...
BODY_BEFORE;
	...
	if( isset( $luxe['body_link_color'] ) ) {
		/* リンク色 */
		if( isset( $luxe['body_link_color'] ) ) {
			$style['all'] .= 'body a{color:' . $luxe['body_link_color'] . ';}';
		}
	...
	if( isset( $luxe['body_hover_color'] ) ) {
		/* リンクホバー色 */
		if( isset( $luxe['body_hover_color'] ) ) {
			$style['all'] .= 'body a:hover{color:' . $luxe['body_hover_color'] . ';}';
		}
	...
	if( isset( $luxe['font_size_scale'] ) && (float)$luxe['font_size_scale'] !== (float)$defaults['font_size_scale'] ) {
		$style['all'] .= 'html{font-size:' . $luxe['font_size_scale'] . '%!important;}';
	}
	// Body
	if( isset( $luxe['font_size_body'] ) && (float)$luxe['font_size_body'] !== (float)$defaults['font_size_body'] ) {
		$rem = (float)$luxe['font_size_body'] / 10;
		$style['min_576'] .= 'body, li, pre, blockquote {';
		$style['min_576'] .= 'font-size:' . $luxe['font_size_body'] . 'px;';
