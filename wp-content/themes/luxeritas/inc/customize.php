...
class luxe_customize {
	...
	public function luxe_custom_form() {
		...
		elseif( $this->_page === 'luxe_man' ) {
			$this->_active = isset( $_GET['active'] ) ? $_GET['active'] : 'widget';
...
<?php
	...
	private function _phrase_section() {
		...
		add_settings_section( 'phrase-options', __( 'Options', 'luxeritas' ), array( $this, 'sections' ), $this->_active );
	}
	...
	private function _shortcode_section() {
		...
		add_settings_section( 'shortcode-options', __( 'Options', 'luxeritas' ), array( $this, 'sections' ), $this->_active );
	}
