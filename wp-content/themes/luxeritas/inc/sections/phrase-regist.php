...
function _thk_phrase_options_input() {
	// type="hidden" にすると phrase-options.php の checkbox と両方処理しないといけなくなって無駄が出るから display:none でまとめる
?>
