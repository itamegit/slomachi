	...
	if(
		...
		if( check_admin_referer( $_POST['option_page'] . '-options', '_wpnonce' ) ) {
			...
			elseif( $_POST['option_page'] === 'phrase' || $_POST['option_page'] === 'phrase_options' ) {
				...
				thk_customize_result_set( 'add_phrase_button_1', 'checkbox', 'admin' );
				thk_customize_result_set( 'add_phrase_button_2', 'checkbox', 'admin' );
			}
			elseif( $_POST['option_page'] === 'shortcode' || $_POST['option_page'] === 'shortcode_options') {
				...
				thk_customize_result_set( 'add_post_shortcode_button_1', 'checkbox', 'admin' );
				thk_customize_result_set( 'add_post_shortcode_button_2', 'checkbox', 'admin' );
			}
