...
<p class="m25-b"><a href="<?php echo esc_url( admin_url( 'admin.php?page=luxe&active=backup' ) ); ?>"><?php echo __( 'Recommend that you backup appearance customization before changing.', 'luxeritas' ); ?></a></p>
<ul>
<li>
<?php
