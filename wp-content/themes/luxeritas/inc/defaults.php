...
class defConfig {
	...
	public function admin_variables() {
		return array(
			'parent_css_uncompress'		=> false,
			'measures_against_waf'		=> false,
			'add_phrase_button_1'		=> true,
			'add_phrase_button_2'		=> true,
			'add_post_shortcode_button_1'	=> true,
			'add_post_shortcode_button_2'	=> true,
			'mce_max_width'		=> 0,
			'mce_color'		=> '#000000',
			'mce_bg_color'		=> '#ffffff',
	...
	public function set_luxe_variable() {
		...
		if( $this->_is_admin === true ) {
			require_once( INC . 'thk-mod-class.php' );
		...
		// Remote check
		if( thk_remote_check() === true ) $mods['rc'] = true;
