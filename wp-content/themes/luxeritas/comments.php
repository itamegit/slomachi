...
?>
<ol class="comments-list" itemscope itemtype="https://schema.org/UserComments">
<?php
...
if( isset( $luxe['captcha_enable'] ) && $luxe['captcha_enable'] !== 'none' ) {
	// reCAPTCHA
	if( $luxe['captcha_enable'] === 'recaptcha' && isset( $luxe['recaptcha_site_key'] ) && !empty( $luxe['recaptcha_site_key'] ) ) {
		add_filter( 'comment_form_default_fields', function( $fields ) use( $luxe ) {
			$fields += array(
