...
add_action( 'customize_register', function( $wp_customize ) {
	...
	$wp_customize->add_control( 'font_japanese', array(
		...
		'choices'	=> array(
			'none'			=> __( 'Not specified', 'luxeritas' ),
			'notosansjapanese'	=> __( '[ Web font ]', 'luxeritas' ) . ' Noto Sans Japanese',
			'mplus1p'		=> __( '[ Web font ]', 'luxeritas' ) . ' M+ 1p',
			'roundedmplus1c'	=> __( '[ Web font ]', 'luxeritas' ) . ' Rounded M+ 1c',
...
*/
	...
	$wp_customize->add_control( 'sns_fb_appid', array(
		...
		'description'	=> '<span class="bold">(' . __( 'used for getting count on Facebook', 'luxeritas' ) . ')</span><p class="f09em">' . __( '* current API allows to get the count without it, but it may become mandatory in future.', 'luxeritas' ) . '</p>',
		'section'	=> 'sns_section',
		'type'		=> 'text',
		'priority'	=> 75
	));
